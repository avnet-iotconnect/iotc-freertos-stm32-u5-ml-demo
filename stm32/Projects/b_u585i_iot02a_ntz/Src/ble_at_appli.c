...
/* */
static void ble_at_uart_error_cb( UART_HandleTypeDef * UartHandle )
{
	(void) UartHandle;
	printf("  BT UART ERROR\r\n");
}

static void ble_at_uart_rx_done_cb(UART_HandleTypeDef *UartHandle)
{
...
HAL_StatusTypeDef ble_at_appli_register_uart_callbacks(UART_HandleTypeDef* uart_handle)
{
